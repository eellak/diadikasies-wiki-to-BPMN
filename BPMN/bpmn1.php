...
<div id="S0">
<div class="w3-container w3-tangerine" align="center"><p class="w3-large">Διαδικασία δημιουργίας BPMN βάσει CPSV+CPOV...</p></div>
<div align="right">Αυτόματη εκτέλεση <input id="auto" type="checkbox">   <button id="btn-auto" class="w3-button w3-xlarge w3-circle w3-red w3-card-4" style="visibility:visible" type="button" onclick="auto()">+</button></div>
</div>
...
<div class="divTableCell">Εδώ εμφανίζονται επιλογές σε περίπτωση που έχουμε CPSV-based Wiki σελίδα διαδικασίας<br><button class="button" id="btn2" style="visibility:hidden" type="button" onclick="addBPMNsection(urlsaved, 'BPMN Σύνδεσμος στο Repository',path_bpmn_href)">Προσθήκη BPMN Συνδέσμου στη Wiki σελίδα</button>
<button class="button" id="btn2b" style="visibility:hidden" type="button" onclick="addBPMNsection(urlsaved, 'BPMN Διάγραμμα',bpmnEmbed)">Ενσωμάτωση BPMN Διαγράμματος στη Wiki σελίδα</button>
<button class="button" id="btn2c" style="visibility:hidden" type="button" onclick="addBPMNsection(urlsaved, 'BPMN Wiki σελίδα',BPMNwikipage )">Ενσωμάτωση BPMN wiki page στην αρχική Wiki σελίδα</button>
</div>
